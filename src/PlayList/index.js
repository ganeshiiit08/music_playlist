...
class PlayList extends Component {
  ...
  getNoSongsView = () => (
    <NoSongsContainer>
      <NoSongsHeader>No Songs Found</NoSongsHeader>
    </NoSongsContainer>
  )
  ...
  render() {
    ...
    return (
      <AppContainer>
        <SingerBgContainer data-testid="artist-details">
          <SingerNameText>
            Ed Sheeran
            <br />
            <SingerInfoText>Singer</SingerInfoText>
          </SingerNameText>
        </SingerBgContainer>
        <SongsPlayListDiv>
          <PlayListHeader>Songs Playlist</PlayListHeader>
          <SearchInput
            type="search"
            value={searchInput}
            placeholder="Search"
